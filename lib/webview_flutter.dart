...
import 'src/webview_android_hybrid.dart';
...
class _WebViewState extends State<WebView> {
  ...
  Widget build(BuildContext context) {
    if (true == widget.useHybridWebView && Platform.isAndroid) {
      WebView.platform = AndroidWebViewHybrid();
    }
